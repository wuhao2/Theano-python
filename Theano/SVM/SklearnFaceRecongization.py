...
print("n_samples: %d" % n_samples)    # instance n_samples: 1288
print("n_features: %d" % n_features)  #n_features: 1850
print("n_classes: %d" % n_classes)   #n_classes: 7
...
print("done in %0.3fs" % (time() - t0))  #done in 0.502s
